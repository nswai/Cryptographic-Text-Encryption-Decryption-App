...
// =================================================================
// 1. КОНСТАНТИ АЛФАВІТІВ ДЛЯ КИРИЛИЦІ ТА ЛАТИНИЦІ
// =================================================================
...
// =================================================================
// 2. БАЗОВІ АБСТРАКТНІ КЛАСИ ТА ІНТЕРФЕЙСИ
// =================================================================
...
// =================================================================
// 3. ГРАФІЧНИЙ ІНТЕРФЕЙС (WIN32 GUI)
// =================================================================

#define IDC_BTN_ENCRYPT 101
#define IDC_BTN_DECRYPT 102
#define IDC_COMBO_CIPHER 103
#define IDC_BTN_SWAP    104  // Новий ідентифікатор для кнопки реверсу
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_CREATE: {
        ...
        // Створення нової кнопки обміну текстом (Реверс)
    ...
    case WM_COMMAND: {
        // ОБРОБКА КНОПКИ РЕВЕРСУ (ОБМІНУ ТЕКСТОМ)
        if (LOWORD(wParam) == IDC_BTN_SWAP) {
            ...
            if (outLen > 0) {
                ...
                // Записуємо результат у вікно введення і очищаємо вікно результату
        ...
        // ОБРОБКА ШИФРУВАННЯ ТА ДЕШИФРУВАННЯ
